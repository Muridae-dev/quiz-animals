...
function initSabimango() {
  var content =
    '      <div id="question"><div id="imgBox"></div> <input class="radio" type="radio" id="k1" name="fraga1" /> <label for="k1"></label><br /><input class="radio" type="radio" id="k2" name="fraga1" /> <label for="k2"></label> <br /><input class="radio" type="radio" id="k3" name="fraga1" /><label for="k3"></label> <br />   <input class="radio" type="radio" id="k4" name="fraga1" />   <label for="k4"></label> <br /> <input type="radio" id="k5" name="fraga1" /> <label for="k5"></label><br />      <button id="submit" onclick="checkMangoAnswer()">Submit! :)</button>    </div> </div>  ';
