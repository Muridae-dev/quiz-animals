...
function randomInit() {
    ...
    /*else if(randomQuestion == 4) initSilhouette();
    else if(randomQuestion == 5) initGhibli();*/
    else if(pictureArray.length == 0 && quiz.length == 0 && makeGlasses.length == 0 && noMoreThan5 >= 5) init();
    else {randomInit();}
}
...
function firstInit() {
    ...
    audio.play();
    document.getElementsByTagName("body")[0].innerHTML = '    <div id="scoreBox">        SCORE:0    </div>    <div class="funBox">        <div class="funText">asdasdasdas</div>    </div>    <div id="textBox">                </div>    <div id="containerBox">            </div>';
